...
export default function Referee() {
    ...
    //             validMove = princeMove(initialPosition, desiredPosition, team, board.pieces);
    //             break;
    //         case PieceType.PRINCESS:
    //             validMove = princessMove(initialPosition, desiredPosition, team, board.pieces);
    //             break;
    //     }
        ...
        <div>
            ...
            <div className="modal hidden" ref={modalRef}>
                <div className="modal-body">
                    <img onClick={() => promotePawn(PieceType.ROOK)} alt="" src={`/assets/images/rook_${promotionTeamType()}.png`} />
                    <img onClick={() => promotePawn(PieceType.BISHOP)} alt="" src={`/assets/images/bishop_${promotionTeamType()}.png`} />
                    <img onClick={() => promotePawn(PieceType.KNIGHT)} alt="" src={`/assets/images/knight_${promotionTeamType()}.png`} />
                    <img onClick={() => promotePawn(PieceType.QUEEN)} alt="" src={`/assets/images/queen_${promotionTeamType()}.png`} />
                </div>
            </div>
